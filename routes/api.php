...
// Route::get('bookables', 'Api\BookableControllerr@index');

// Route::get('bookables/{id}', 'Api\BookableControllerr@show');

Route::apiResource('bookables', 'Api\BookableControllerr')->only(['index','show']);
